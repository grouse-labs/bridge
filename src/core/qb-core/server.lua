...
function core.getplayermoney(player, money_type)
  ...
  return Player.PlayerData.money[money_type]
end
...
function core.addplayermoney(player, money_type, amount)
  ...
  Player.Functions.AddMoney(money_type, amount, 'bridge added money: '..amount)
...
function core.removeplayermoney(player, money_type, amount)
  ...
  local prev = core.getplayermoney(player, money_type)
  Player.Functions.RemoveMoney(money_type, amount, 'bridge removed money: '..amount)
  return core.getplayermoney(player, money_type) == prev - amount
end
...
function core.removeplayeritem(player, item_name, amount)
  ...
  return not core.doesplayerhaveitem(player, item_name, amount)
end
...
function core.getitems()
  ...
  if not QBItems or not next(QBItems) then error('error calling \'getitems\' (items not found)', 2) end
