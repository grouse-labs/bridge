...
local function trigger_callback(player, name, cb, ...)
  if not IsSrcAPlayer(player or source) then error('bad argument #1 to \'TriggerCallback\' (number or string expected, got '..player..')', 2) end
...
local function await_callback(player, name, ...)
  if not IsSrcAPlayer(player or source) then error('bad argument #1 to \'AwaitCallback\' (number or string expected, got '..player..')', 2) end
